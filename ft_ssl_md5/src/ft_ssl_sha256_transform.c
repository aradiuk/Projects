...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_ssl_sha256_transform.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aradiuk <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/08 11:26:47 by aradiuk           #+#    #+#             */
/*   Updated: 2019/04/08 11:26:47 by aradiuk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
						...
						t_byte buffer[FT_SHA256_BUFFER_SIZE])
{
	...
	ft_ssl_sha256_intermediate_st(st, temp_st);
...
void	ft_ssl_sha256_intermediate_st(uint32_t st[8], uint32_t temp_st[8])
{
	int	i;
						...
						uint32_t decoded[FT_SHA256_BUFFER_SIZE])
{
	...
	while (i < FT_SHA256_BUFFER_SIZE)
	{
		t1 = st[7] + SHA256_CHANGE_SCH1(st[4]) +
				SHA256_CH(st[4], st[5], st[6]) +
				g_k[i] + decoded[i];
